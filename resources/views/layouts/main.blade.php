...
<!-- Mirrored from rhythm-admin-template.multipurposethemes.com/main/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 May 2023 09:22:34 GMT -->
...
<body class="hold-transition light-skin sidebar-mini theme-success fixed">
                ...
                <a href="index.html" class="logo">
                    ...
                    <div class="logo-mini w-50">
                        <span class="light-logo"><img
                                src="https://rhythm-admin-template.multipurposethemes.com/images/logo-letter.png"
                                alt="logo"></span>
                    ...
                    <div class="logo-lg">
                        <span class="light-logo"><img
                                src="https://rhythm-admin-template.multipurposethemes.com/images/logo-dark-text.png"
                                alt="logo"></span>
                        <span class="dark-logo"><img
                                src="https://rhythm-admin-template.multipurposethemes.com/images/logo-light-text.png"
                                alt="logo"></span>
                    </div>
                </a>
            </div>
                                    ...
                                    <ul class="menu sm-scrol">
                                        ...
                                        <li>
                                            <a href="#">
												...
												primary"></i> Nunc fringilla lorem
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                    ...
                    <div class="multinav-scroll" style="height: 100%;">
                        ...
                        <ul class="sidebar-menu" data-widget="tree">
                            ...
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    <li><a href="patients.html"><i class="icon-Commit"><span
                                                    class="path1"></span><span class="path2"></span></i>Patients</a>
                                    </li>
                                    <li><a href="patient_details.html"><i class="icon-Commit"><span
                            ...
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    <li><a href="doctor_list.html"><i class="icon-Commit"><span
                                                    class="path1"></span><span class="path2"></span></i>Doctors</a>
                                    </li>
                                    <li><a href="doctors.html"><i class="icon-Commit"><span
                                    ...
                                    <li class="treeview">
                                        ...
                                        <ul class="treeview-menu">
                                            ...
                                            <li><a href="charts_echarts_pie_doughnut.html"><i
                                                        class="icon-Commit"><span class="path1"></span><span
                                                            class="path2"></span></i>Pie & Doughnut Chart</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                        ...
                        <div class="sidebar-widgets">
                            ...
                            <div class="copyright text-center m-25">
                                <p><strong class="d-block">Rhythm Admin Dashboard</strong> ©
                                    <script>
                    ...
                    <div class="media-list media-list-hover mt-20">
                        ...
                        <div class="media py-10 px-0">
                            <a class="avatar avatar-lg status-primary" href="#">
                                <img src="https://rhythm-admin-template.multipurposethemes.com/images/avatar/4.jpg"
                                    alt="...">
                            </a>
                            <div class="media-body">
                                <p class="fs-16">
    ...
    <script
        src="https://rhythm-admin-template.multipurposethemes.com/assets/vendor_components/apexcharts-bundle/dist/apexcharts.js">
    </script>
    <script
        src="https://rhythm-admin-template.multipurposethemes.com/assets/vendor_components/OwlCarousel2/dist/owl.carousel.js">
    </script>
...
<!-- Mirrored from rhythm-admin-template.multipurposethemes.com/main/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 May 2023 09:24:38 GMT -->
